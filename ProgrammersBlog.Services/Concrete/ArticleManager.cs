...
namespace ProgrammersBlog.Services.Concrete
{
    public class ArticleManager:IArticleService
    {
        ...
        public async Task<IResult> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            return new Result(ResultStatus.Success, $"{articleAddDto.Title}adlı makale eklendi");
        }
        ...
        public async Task<IResult> Update(ArticleUpdateDto articleUpdateDto, string modifiedByName)
        {
            ...
            return new Result(ResultStatus.Success, $"{articleUpdateDto.Title}adlı makale güncellendi");
        }
        ...
        public async Task<IResult> Delete(int articleId, string modifiedByName)
        {
            ...
            if (result)
            {
                ...
                await _unitOfWork.Articles.UpdateAsync(article).ContinueWith(x => _unitOfWork.SaveAsync());
                return new Result(ResultStatus.Success, $"{article.Title}adlı makale silindi");
            }
        ...
        public async Task<IResult> HardDelete(int articleId)
        {
            ...
            if (result)
            {
                ...
                return new Result(ResultStatus.Success, $"{article.Title}adlı makale veritabanından silindi");
            }
            return new Result(ResultStatus.Error, " makale bulunamadı");
        }
    }
